...
function init(){
    ...
    setInterval(createPropagation, 10)
    audio.play()
}
...
function updatePropagation(currentPixelIndex){
    ...
    const newFireIntensity = 
        belowPixelFireIntensity - decay*acumulate >= 0 ? belowPixelFireIntensity - decay*acumulate : 0;
